                            ...
                            <div id="carouselExampleCaptions" class="carousel slide  mx-auto">
                                <div class="carousel-indicators">
                                    ...
                                    ?>
                                        ...
                                        <button type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="<?= $key; ?>" <?php if ($key == 0) {
                                                                                                                                            echo "class='active'";
                                                                                                                                        } ?>></button>
                                    <?php } ?>
                                </div>
                                <div class="carousel-inner">
                                    <?php foreach ($galeries as $key => $galerie) { ?>
                                        <div class="carousel-item <?php if ($key == 0) {
                                            ...
                                            <img class="d-block w-100" src="<?= BASE_PATH . $galerie['title_media']; ?>" alt="<?= $galerie['name_media']  ?>">
                                        </div>
                                    <?php  } ?>
                                </div>
                ...
                <?php foreach ($comments as $comment) : ?>
                    <div class="col-12 col-md-6 d-flex justify-content-center ">
                        ...
                        <div class=" w-100 rep1 bloc d-flex  border border-light">
                            <div class="p-2">
                                <img width="90" src="<?= BASE_PATH . $comment['title_media']; ?>" alt="<?= $comment['name_media']  ?>" class="img-fluid">
                            </div>
