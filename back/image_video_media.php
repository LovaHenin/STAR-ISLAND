...
<?php foreach ($medias_images_galerie as $media_galerie) : ?>
    ...
    <div class="card mr-3" style="width: 10rem;">
        ...
        <img src="<?= BASE_PATH . $media_galerie['title_media']; ?>" class="card-img-top" alt="<?= $media_galerie['name_media']   ?>">
        <div class="card-body">
...
<?php foreach ($medias_images_avatarTeams as $media_avatarTeam) : ?>
    ...
    <div class="card mr-3" style="width: 10rem;">
        ...
        <img src="<?= BASE_PATH . $media_avatarTeam['title_media']; ?>" class="card-img-top" alt="<?= $media_avatarTeam['name_media']   ?>">
        <div class="card-body">
...
<?php foreach ($medias_images_avatar as $media_avatar) : ?>
    ...
    <div class="card mr-3" style="width: 10rem;">
        ...
        <img src="<?= BASE_PATH  . $media_avatar['title_media']; ?>" class="card-img-top" alt="<?= $media_avatar['name_media']   ?>">
        <div class="card-body">
...
<?php foreach ($medias_images_event as $media_event) : ?>
    ...
    <div class="card mr-3" style="width: 10rem;">
        ...
        <img src="<?= BASE_PATH  . $media_event['title_media']; ?>" class="card-img-top" alt="<?= $media_event['name_media']   ?>">
        <div class="card-body">
