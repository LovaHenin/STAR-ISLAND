...
<div class="container" style="margin-top: 250px;">
  ...
  <div class="row text-center justify-content-between">
    ...
    <div class="col-12 col-md-4">
      <img id="vipG" src="<?= BASE_PATH . 'assets/img/Group5M.png' ?>" alt="personnage" class="img-fluid">
    </div>
    ...
    <div class="col-12 col-md-4">
      ...
      <img id="vipD" src="<?= BASE_PATH . 'assets/img/Group 6.png' ?>" alt="personnage" class="img-fluid">
    </div>
